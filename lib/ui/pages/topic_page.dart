...
class _TopicPageState extends State<TopicPage> {
  List<PostItem> loadPosts = new List<PostItem>();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
      ...
      body: ListView(
        children: [
          SearchWidget<PostItem>(
            dataList: loadPosts,
            queryBuilder: (String query, List<PostItem> list) {
              return list.toList();
            },
            selectedItemBuilder: (PostItem topicItem, Function function) {
              return PostItem();
            },
            popupListItemBuilder: (PostItem item) {
              return PostItem();
            },
          ),
          PostList(
